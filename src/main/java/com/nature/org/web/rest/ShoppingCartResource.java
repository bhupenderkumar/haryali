...
/**
 * REST controller for managing {@link com.nature.org.domain.ShoppingCart}.
 */
@RestController
@RequestMapping("/api")
public class ShoppingCartResource {
    ...
    /**
     * {@code SEARCH  /_search/shopping-carts?query=:query} : search for the shoppingCart corresponding
     * to the query.
     *
    ...
    public List<ShoppingCart> searchShoppingCarts(@RequestParam String query) {
