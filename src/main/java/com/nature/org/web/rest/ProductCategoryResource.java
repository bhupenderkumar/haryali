...
import com.nature.org.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link com.nature.org.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
public class ProductCategoryResource {
    ...
    public ResponseEntity<List<ProductCategory>> searchProductCategories(@RequestParam String query, Pageable pageable) {
